...
/*     */ {
/*  59 */   private static final Logger LOGGER = LoggerFactory.getLogger(ReportResource.class);
/*     */ 
/*     */   
...
/*  84 */             } catch (SQLException|IOException|javax.mail.MessagingException e) {
/*     */               LOGGER.warn("Report failed", e);
/*     */             } 
/*  87 */           })).start();
/*  88 */       return Response.noContent().build();
/*     */     } 
/*  90 */     executor.execute(stream);
/*  91 */     return Response.ok(stream.toByteArray())
/*  92 */       .header("Content-Disposition", "attachment; filename=report.xlsx").build();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 101 */     return Route.getObjects(getUserId(), deviceIds, groupIds, 
/* 102 */         DateUtil.parseDate(from), DateUtil.parseDate(to));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 112 */     return executeReport(getUserId(), mail, stream -> Route.getExcel(stream, getUserId(), deviceIds, groupIds, DateUtil.parseDate(from), DateUtil.parseDate(to)));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 124 */     return Events.getObjects(getUserId(), deviceIds, groupIds, types, 
/* 125 */         DateUtil.parseDate(from), DateUtil.parseDate(to));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 136 */     return executeReport(getUserId(), mail, stream -> Events.getExcel(stream, getUserId(), deviceIds, groupIds, types, DateUtil.parseDate(from), DateUtil.parseDate(to)));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 147 */     return Summary.getObjects(getUserId(), deviceIds, groupIds, 
/* 148 */         DateUtil.parseDate(from), DateUtil.parseDate(to));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 158 */     return executeReport(getUserId(), mail, stream -> Summary.getExcel(stream, getUserId(), deviceIds, groupIds, DateUtil.parseDate(from), DateUtil.parseDate(to)));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 170 */     return Trips.getObjects(getUserId(), deviceIds, groupIds, 
/* 171 */         DateUtil.parseDate(from), DateUtil.parseDate(to));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 181 */     return executeReport(getUserId(), mail, stream -> Trips.getExcel(stream, getUserId(), deviceIds, groupIds, DateUtil.parseDate(from), DateUtil.parseDate(to)));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 193 */     return Stops.getObjects(getUserId(), deviceIds, groupIds, 
/* 194 */         DateUtil.parseDate(from), DateUtil.parseDate(to));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 204 */     return executeReport(getUserId(), mail, stream -> Stops.getExcel(stream, getUserId(), deviceIds, groupIds, DateUtil.parseDate(from), DateUtil.parseDate(to)));
/*     */   }
/*     */   
