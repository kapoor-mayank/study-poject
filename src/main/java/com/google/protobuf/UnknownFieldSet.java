...
/*  338 */         return null;
/*      */       }
/*  340 */       Field existing = this.fields.get(Integer.valueOf(number));
/*  341 */       this.lastFieldNumber = number;
/*  342 */       this.lastField = Field.newBuilder();
...
/*      */         
/*  366 */         descendingFields = Collections.unmodifiableMap(((TreeMap<? extends Integer, ? extends Field>)this.fields).descendingMap());
...
/*      */       
/*  384 */       descendingFields = Collections.unmodifiableMap(((TreeMap<? extends Integer, ? extends Field>)this.fields).descendingMap());
...
/*  428 */         for (Map.Entry<Integer, Field> entry : (Iterable<Map.Entry<Integer, Field>>)other.fields.entrySet()) {
...
/*      */         } 
/*      */         
/*  958 */         Field returnMe = this.result;
...
/* 1060 */       Builder builder = UnknownFieldSet.newBuilder();
/*      */       try {
...
/* Location:              C:\User\\user\Documents\Ensurity Mobile [Client]\Latest App\traccar\tracker-server.jar!\com\google\protobuf\UnknownFieldSet.class
