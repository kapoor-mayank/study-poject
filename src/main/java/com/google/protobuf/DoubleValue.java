...
/*     */ 
/*     */     
/* 108 */     this.memoizedIsInitialized = -1; } protected Object newInstance(UnusedPrivateParameter unused) { return new DoubleValue(); } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private DoubleValue() { this.memoizedIsInitialized = -1; }
...
/* 116 */     return true; } public static final Descriptors.Descriptor getDescriptor() { return WrappersProto.internal_static_google_protobuf_DoubleValue_descriptor; } protected FieldAccessorTable internalGetFieldAccessorTable() {
...
/* 122 */     if (this.value_ != 0.0D) {
/* 123 */       output.writeDouble(1, this.value_);
/*     */     }
...
/*     */     
/* 133 */     size = 0;
/* 134 */     if (this.value_ != 0.0D) {
/* 135 */       size += 
/* 136 */         CodedOutputStream.computeDoubleSize(1, this.value_);
/*     */     }
...
/* 146 */       return true;
/*     */     }
/* 148 */     if (!(obj instanceof DoubleValue)) {
/* 149 */       return super.equals(obj);
/*     */     }
/* 151 */     DoubleValue other = (DoubleValue)obj;
/*     */     
/* 153 */     if (Double.doubleToLongBits(getValue()) != 
/* 154 */       Double.doubleToLongBits(other
...
/* 167 */     hash = 37 * hash + 1;
/* 168 */     hash = 53 * hash + Internal.hashLong(
/* 169 */         Double.doubleToLongBits(getValue()));
...
/* 209 */     return 
/* 210 */       GeneratedMessageV3.<DoubleValue>parseWithIOException(PARSER, input);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 216 */     return 
/* 217 */       GeneratedMessageV3.<DoubleValue>parseWithIOException(PARSER, input, extensionRegistry);
/*     */   }
/*     */   
/*     */   public static DoubleValue parseDelimitedFrom(InputStream input) throws IOException {
/* 221 */     return 
/* 222 */       GeneratedMessageV3.<DoubleValue>parseDelimitedWithIOException(PARSER, input);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 228 */     return 
/* 229 */       GeneratedMessageV3.<DoubleValue>parseDelimitedWithIOException(PARSER, input, extensionRegistry);
/*     */   }
/*     */ 
/*     */   
/*     */   public static DoubleValue parseFrom(CodedInputStream input) throws IOException {
/* 234 */     return 
/* 235 */       GeneratedMessageV3.<DoubleValue>parseWithIOException(PARSER, input);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 241 */     return 
/* 242 */       GeneratedMessageV3.<DoubleValue>parseWithIOException(PARSER, input, extensionRegistry);
/*     */   }
/*     */   
...
/* 279 */       return WrappersProto.internal_static_google_protobuf_DoubleValue_descriptor;
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     protected FieldAccessorTable internalGetFieldAccessorTable() {
/* 285 */       return WrappersProto.internal_static_google_protobuf_DoubleValue_fieldAccessorTable
/* 286 */         .ensureFieldAccessorsInitialized((Class)DoubleValue.class, (Class)Builder.class);
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 316 */       return WrappersProto.internal_static_google_protobuf_DoubleValue_descriptor;
/*     */     }
/*     */ 
/*     */     
/*     */     public DoubleValue getDefaultInstanceForType() {
/* 321 */       return DoubleValue.getDefaultInstance();
/*     */     }
/*     */ 
/*     */     
/*     */     public DoubleValue build() {
/* 326 */       DoubleValue result = buildPartial();
...
/* 335 */       DoubleValue result = new DoubleValue(this);
...
/* 375 */       if (other instanceof DoubleValue) {
/* 376 */         return mergeFrom((DoubleValue)other);
/*     */       }
...
/* 384 */       if (other == DoubleValue.getDefaultInstance()) return this; 
/* 385 */       if (other.getValue() != 0.0D) {
...
/* 403 */       DoubleValue parsedMessage = null;
/*     */       try {
/* 405 */         parsedMessage = DoubleValue.PARSER.parsePartialFrom(input, extensionRegistry);
/* 406 */       } catch (InvalidProtocolBufferException e) {
/* 407 */         parsedMessage = (DoubleValue)e.getUnfinishedMessage();
...
/*     */ 
/*     */   
/* 478 */   private static final DoubleValue DEFAULT_INSTANCE = new DoubleValue();
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 490 */   private static final Parser<DoubleValue> PARSER = new AbstractParser<DoubleValue>()
/*     */     {
/*     */ 
/*     */       
...
/*     */       {
/* 496 */         return new DoubleValue(input, extensionRegistry);
/*     */       }
/*     */     };
/*     */   
...
/* Location:              C:\User\\user\Documents\Ensurity Mobile [Client]\Latest App\traccar\tracker-server.jar!\com\google\protobuf\DoubleValue.class
