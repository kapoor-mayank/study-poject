...
/*      */         }
/*  704 */         DecodeUtil.handleFourBytes(byte1, buffer
/*      */             
...
/*      */           }  continue;
/*  996 */         }  if (DecodeUtil.isTwoBytes(byte1)) {
/*  997 */           if (offset >= limit) {
/*  998 */             throw InvalidProtocolBufferException.invalidUtf8();
/*      */           }
/* 1000 */           DecodeUtil.handleTwoBytes(byte1, bytes[offset++], resultArr, resultPos++); continue;
/* 1001 */         }  if (DecodeUtil.isThreeBytes(byte1)) {
/* 1002 */           if (offset >= limit - 1) {
/* 1003 */             throw InvalidProtocolBufferException.invalidUtf8();
/*      */           }
/* 1005 */           DecodeUtil.handleThreeBytes(byte1, bytes[offset++], bytes[offset++], resultArr, resultPos++);
/*      */ 
/*      */           
/*      */           continue;
/*      */         } 
...
/*      */         }
/* 1015 */         DecodeUtil.handleFourBytes(byte1, bytes[offset++], bytes[offset++], bytes[offset++], resultArr, resultPos++);
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */         }
/* 1427 */         DecodeUtil.handleFourBytes(byte1,
/*      */             
...
/*      */         }
/* 1503 */         DecodeUtil.handleFourBytes(byte1,
/*      */             
...
/* Location:              C:\User\\user\Documents\Ensurity Mobile [Client]\Latest App\traccar\tracker-server.jar!\com\google\protobuf\Utf8.class
