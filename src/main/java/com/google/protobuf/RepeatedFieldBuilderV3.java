...
/*     */     }
/*     */     
/* 361 */     for (AbstractMessage abstractMessage : values) {
/* 362 */       addMessage((MType)abstractMessage);
/*     */     }
/*     */     
/* 365 */     onChanged();
...
/* 378 */     ensureBuilders();
/* 379 */     SingleFieldBuilderV3<MType, BType, IType> builder = new SingleFieldBuilderV3<>(message, this, this.isClean);
/*     */     
...
/* 398 */     ensureBuilders();
/* 399 */     SingleFieldBuilderV3<MType, BType, IType> builder = new SingleFieldBuilderV3<>(message, this, this.isClean);
/*     */     
...
/* 418 */       SingleFieldBuilderV3<MType, BType, IType> entry = this.builders.remove(index);
/* 419 */       if (entry != null) {
/* 420 */         entry.dispose();
/*     */       }
/*     */     } 
...
/* 432 */       for (SingleFieldBuilderV3<MType, BType, IType> entry : this.builders) {
/* 433 */         if (entry != null) {
/* 434 */           entry.dispose();
/*     */         }
/*     */       } 
...
/* 464 */         SingleFieldBuilderV3<MType, BType, IType> builder = this.builders.get(j);
/* 465 */         if (builder != null && 
...
/* Location:              C:\User\\user\Documents\Ensurity Mobile [Client]\Latest App\traccar\tracker-server.jar!\com\google\protobuf\RepeatedFieldBuilderV3.class
