...
/*     */ 
/*     */     
/* 108 */     this.memoizedIsInitialized = -1; } protected Object newInstance(UnusedPrivateParameter unused) { return new Int64Value(); } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private Int64Value() { this.memoizedIsInitialized = -1; }
...
/* 116 */     return true; } public static final Descriptors.Descriptor getDescriptor() { return WrappersProto.internal_static_google_protobuf_Int64Value_descriptor; } protected FieldAccessorTable internalGetFieldAccessorTable() {
...
/* 123 */       output.writeInt64(1, this.value_);
/*     */     }
...
/* 135 */       size += 
/* 136 */         CodedOutputStream.computeInt64Size(1, this.value_);
/*     */     }
...
/* 146 */       return true;
/*     */     }
/* 148 */     if (!(obj instanceof Int64Value)) {
/* 149 */       return super.equals(obj);
/*     */     }
/* 151 */     Int64Value other = (Int64Value)obj;
/*     */     
...
/* 208 */     return 
/* 209 */       GeneratedMessageV3.<Int64Value>parseWithIOException(PARSER, input);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 215 */     return 
/* 216 */       GeneratedMessageV3.<Int64Value>parseWithIOException(PARSER, input, extensionRegistry);
/*     */   }
/*     */   
/*     */   public static Int64Value parseDelimitedFrom(InputStream input) throws IOException {
/* 220 */     return 
/* 221 */       GeneratedMessageV3.<Int64Value>parseDelimitedWithIOException(PARSER, input);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 227 */     return 
/* 228 */       GeneratedMessageV3.<Int64Value>parseDelimitedWithIOException(PARSER, input, extensionRegistry);
/*     */   }
/*     */ 
/*     */   
/*     */   public static Int64Value parseFrom(CodedInputStream input) throws IOException {
/* 233 */     return 
/* 234 */       GeneratedMessageV3.<Int64Value>parseWithIOException(PARSER, input);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 240 */     return 
/* 241 */       GeneratedMessageV3.<Int64Value>parseWithIOException(PARSER, input, extensionRegistry);
/*     */   }
/*     */   
...
/* 278 */       return WrappersProto.internal_static_google_protobuf_Int64Value_descriptor;
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     protected FieldAccessorTable internalGetFieldAccessorTable() {
/* 284 */       return WrappersProto.internal_static_google_protobuf_Int64Value_fieldAccessorTable
/* 285 */         .ensureFieldAccessorsInitialized((Class)Int64Value.class, (Class)Builder.class);
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 315 */       return WrappersProto.internal_static_google_protobuf_Int64Value_descriptor;
/*     */     }
/*     */ 
/*     */     
/*     */     public Int64Value getDefaultInstanceForType() {
/* 320 */       return Int64Value.getDefaultInstance();
/*     */     }
/*     */ 
/*     */     
/*     */     public Int64Value build() {
/* 325 */       Int64Value result = buildPartial();
...
/* 334 */       Int64Value result = new Int64Value(this);
...
/* 374 */       if (other instanceof Int64Value) {
/* 375 */         return mergeFrom((Int64Value)other);
/*     */       }
...
/* 383 */       if (other == Int64Value.getDefaultInstance()) return this; 
...
/* 402 */       Int64Value parsedMessage = null;
/*     */       try {
/* 404 */         parsedMessage = Int64Value.PARSER.parsePartialFrom(input, extensionRegistry);
/* 405 */       } catch (InvalidProtocolBufferException e) {
/* 406 */         parsedMessage = (Int64Value)e.getUnfinishedMessage();
...
/*     */ 
/*     */   
/* 477 */   private static final Int64Value DEFAULT_INSTANCE = new Int64Value();
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 489 */   private static final Parser<Int64Value> PARSER = new AbstractParser<Int64Value>()
/*     */     {
/*     */ 
/*     */       
...
/*     */       {
/* 495 */         return new Int64Value(input, extensionRegistry);
/*     */       }
/*     */     };
/*     */   
...
/* Location:              C:\User\\user\Documents\Ensurity Mobile [Client]\Latest App\traccar\tracker-server.jar!\com\google\protobuf\Int64Value.class
