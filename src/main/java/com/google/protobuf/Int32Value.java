...
/*     */ 
/*     */     
/* 108 */     this.memoizedIsInitialized = -1; } protected Object newInstance(UnusedPrivateParameter unused) { return new Int32Value(); } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private Int32Value() { this.memoizedIsInitialized = -1; }
...
/* 116 */     return true; } public static final Descriptors.Descriptor getDescriptor() { return WrappersProto.internal_static_google_protobuf_Int32Value_descriptor; } protected FieldAccessorTable internalGetFieldAccessorTable() {
...
/* 123 */       output.writeInt32(1, this.value_);
/*     */     }
...
/* 135 */       size += 
/* 136 */         CodedOutputStream.computeInt32Size(1, this.value_);
/*     */     }
...
/* 146 */       return true;
/*     */     }
/* 148 */     if (!(obj instanceof Int32Value)) {
/* 149 */       return super.equals(obj);
/*     */     }
/* 151 */     Int32Value other = (Int32Value)obj;
/*     */     
...
/* 207 */     return 
/* 208 */       GeneratedMessageV3.<Int32Value>parseWithIOException(PARSER, input);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 214 */     return 
/* 215 */       GeneratedMessageV3.<Int32Value>parseWithIOException(PARSER, input, extensionRegistry);
/*     */   }
/*     */   
/*     */   public static Int32Value parseDelimitedFrom(InputStream input) throws IOException {
/* 219 */     return 
/* 220 */       GeneratedMessageV3.<Int32Value>parseDelimitedWithIOException(PARSER, input);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 226 */     return 
/* 227 */       GeneratedMessageV3.<Int32Value>parseDelimitedWithIOException(PARSER, input, extensionRegistry);
/*     */   }
/*     */ 
/*     */   
/*     */   public static Int32Value parseFrom(CodedInputStream input) throws IOException {
/* 232 */     return 
/* 233 */       GeneratedMessageV3.<Int32Value>parseWithIOException(PARSER, input);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 239 */     return 
/* 240 */       GeneratedMessageV3.<Int32Value>parseWithIOException(PARSER, input, extensionRegistry);
/*     */   }
/*     */   
...
/* 277 */       return WrappersProto.internal_static_google_protobuf_Int32Value_descriptor;
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     protected FieldAccessorTable internalGetFieldAccessorTable() {
/* 283 */       return WrappersProto.internal_static_google_protobuf_Int32Value_fieldAccessorTable
/* 284 */         .ensureFieldAccessorsInitialized((Class)Int32Value.class, (Class)Builder.class);
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 314 */       return WrappersProto.internal_static_google_protobuf_Int32Value_descriptor;
/*     */     }
/*     */ 
/*     */     
/*     */     public Int32Value getDefaultInstanceForType() {
/* 319 */       return Int32Value.getDefaultInstance();
/*     */     }
/*     */ 
/*     */     
/*     */     public Int32Value build() {
/* 324 */       Int32Value result = buildPartial();
...
/* 333 */       Int32Value result = new Int32Value(this);
...
/* 373 */       if (other instanceof Int32Value) {
/* 374 */         return mergeFrom((Int32Value)other);
/*     */       }
...
/* 382 */       if (other == Int32Value.getDefaultInstance()) return this; 
...
/* 401 */       Int32Value parsedMessage = null;
/*     */       try {
/* 403 */         parsedMessage = Int32Value.PARSER.parsePartialFrom(input, extensionRegistry);
/* 404 */       } catch (InvalidProtocolBufferException e) {
/* 405 */         parsedMessage = (Int32Value)e.getUnfinishedMessage();
...
/*     */ 
/*     */   
/* 476 */   private static final Int32Value DEFAULT_INSTANCE = new Int32Value();
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 488 */   private static final Parser<Int32Value> PARSER = new AbstractParser<Int32Value>()
/*     */     {
/*     */ 
/*     */       
...
/*     */       {
/* 494 */         return new Int32Value(input, extensionRegistry);
/*     */       }
/*     */     };
/*     */   
...
/* Location:              C:\User\\user\Documents\Ensurity Mobile [Client]\Latest App\traccar\tracker-server.jar!\com\google\protobuf\Int32Value.class
