...
/*     */     implements Iterator<LeafByteString>
/*     */   {
...
/* 743 */         this.next = (LeafByteString)root;
/*     */       } 
/*     */     }
/*     */     
...
/* 762 */           return null;
/*     */         }
/* 764 */         LeafByteString result = getLeafByLeft((this.breadCrumbs.pop()).right);
...
/*     */       }
/* 787 */       LeafByteString result = this.next;
...
/* 848 */       if (bytesRead == 0 && (length > 0 || availableInternal() == 0))
/*     */       {
/*     */ 
/*     */         
/* 852 */         return -1;
...
/* 862 */       if (length > 2147483647L) {
/* 863 */         length = 2147483647L;
/*     */       }
/* 865 */       return readSkipInternal(null, 0, (int)length);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 878 */       int bytesRemaining = length;
/* 879 */       while (bytesRemaining > 0) {
/* 880 */         advanceIfCurrentPieceFullyRead();
/* 881 */         if (this.currentPiece == null) {
/*     */           break;
/*     */         }
/*     */         
/* 885 */         int currentPieceRemaining = this.currentPieceSize - this.currentPieceIndex;
/* 886 */         int count = Math.min(currentPieceRemaining, bytesRemaining);
/* 887 */         if (b != null) {
/* 888 */           this.currentPiece.copyTo(b, this.currentPieceIndex, offset, count);
/* 889 */           offset += count;
/*     */         } 
/* 891 */         this.currentPieceIndex += count;
/* 892 */         bytesRemaining -= count;
/*     */       } 
/*     */ 
/*     */       
/* 896 */       return length - bytesRemaining;
/*     */     }
/*     */ 
/*     */     
/*     */     public int read() throws IOException {
/* 901 */       advanceIfCurrentPieceFullyRead();
/* 902 */       if (this.currentPiece == null) {
/* 903 */         return -1;
/*     */       }
/* 905 */       return this.currentPiece.byteAt(this.currentPieceIndex++) & 0xFF;
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     public int available() throws IOException {
/* 911 */       return availableInternal();
/*     */     }
/*     */ 
/*     */     
...
/* 922 */       this.mark = this.currentPieceOffsetInRope + this.currentPieceIndex;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 928 */       initialize();
/* 929 */       readSkipInternal(null, 0, this.mark);
/*     */     }
/*     */ 
/*     */     
/*     */     private void initialize() {
/* 934 */       this.pieceIterator = new PieceIterator(RopeByteString.this);
/* 935 */       this.currentPiece = this.pieceIterator.next();
/* 936 */       this.currentPieceSize = this.currentPiece.size();
/* 937 */       this.currentPieceIndex = 0;
/* 938 */       this.currentPieceOffsetInRope = 0;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 946 */       if (this.currentPiece != null && this.currentPieceIndex == this.currentPieceSize) {
/*     */ 
/*     */         
/* 949 */         this.currentPieceOffsetInRope += this.currentPieceSize;
/* 950 */         this.currentPieceIndex = 0;
/* 951 */         if (this.pieceIterator.hasNext()) {
/* 952 */           this.currentPiece = this.pieceIterator.next();
/* 953 */           this.currentPieceSize = this.currentPiece.size();
/*     */         } else {
/* 955 */           this.currentPiece = null;
/* 956 */           this.currentPieceSize = 0;
/*     */         } 
/*     */       } 
/*     */     }
/*     */ 
...
/* 963 */       int bytesRead = this.currentPieceOffsetInRope + this.currentPieceIndex;
/* 964 */       return RopeByteString.this.size() - bytesRead;
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\User\\user\Documents\Ensurity Mobile [Client]\Latest App\traccar\tracker-server.jar!\com\google\protobuf\RopeByteString.class
