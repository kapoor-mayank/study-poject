...
/*     */   {
/* 112 */     DOUBLE((String) JavaType.DOUBLE, 1),
/* 113 */     FLOAT((String) JavaType.FLOAT, 5),
/* 114 */     INT64((String) JavaType.LONG, 0),
/* 115 */     UINT64((String) JavaType.LONG, 0),
/* 116 */     INT32((String) JavaType.INT, 0),
/* 117 */     FIXED64((String) JavaType.LONG, 1),
/* 118 */     FIXED32((String) JavaType.INT, 5),
/* 119 */     BOOL((String) JavaType.BOOLEAN, 0),
/* 120 */     STRING((String) JavaType.STRING, 2)
/*     */     {
/*     */       public boolean isPackable() {
/* 123 */         return false;
/*     */       }
/*     */     },
/* 126 */     GROUP((String) JavaType.MESSAGE, 3)
/*     */     {
/*     */       public boolean isPackable() {
/* 129 */         return false;
/*     */       }
/*     */     },
/* 132 */     MESSAGE((String) JavaType.MESSAGE, 2)
/*     */     {
/*     */       public boolean isPackable() {
/* 135 */         return false;
/*     */       }
/*     */     },
/* 138 */     BYTES((String) JavaType.BYTE_STRING, 2)
/*     */     {
/*     */       public boolean isPackable() {
/* 141 */         return false;
/*     */       }
/*     */     },
/* 144 */     UINT32((String) JavaType.INT, 0),
/* 145 */     ENUM((String) JavaType.ENUM, 0),
/* 146 */     SFIXED32((String) JavaType.INT, 5),
/* 147 */     SFIXED64((String) JavaType.LONG, 1),
/* 148 */     SINT32((String) JavaType.INT, 0),
/* 149 */     SINT64((String) JavaType.LONG, 0);
/*     */     
...
/* Location:              C:\User\\user\Documents\Ensurity Mobile [Client]\Latest App\traccar\tracker-server.jar!\com\google\protobuf\WireFormat.class
